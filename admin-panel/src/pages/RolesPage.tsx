...
const RolesPage: React.FC = () => {
  ...
  const roles = [
    {
      ...
      permissions: {
        ...
        clubs: { create: true, read: true, update: true, delete: true },
    ...
    },
    {
      ...
      permissions: {
        ...
        payments: { create: false, read: true, update: true, delete: false },
    ...
    },
    {
      ...
      description: 'Управление бронированиями и клубами',
      userCount: 1,
      color: '#1976d2',
      icon: <Settings />,
      permissions: {
        users: { create: false, read: true, update: false, delete: false },
        clubs: { create: false, read: true, update: true, delete: false },
        bookings: { create: true, read: true, update: true, delete: false },
  ...
  const usersWithRoles = [
    { id: 1, name: 'Асылбек Нурланов', email: 'asylbek@example.com', role: 'SuperAdmin', avatar: 'https://i.pravatar.cc/150?img=1' },
    { id: 2, name: 'Алия Сарсенова', email: 'aliya@example.com', role: 'Admin', avatar: 'https://i.pravatar.cc/150?img=2' },
    { id: 3, name: 'Даурен Муратов', email: 'dauren@example.com', role: 'Manager', avatar: 'https://i.pravatar.cc/150?img=3' },
    { id: 4, name: 'Жанна Касымова', email: 'zhanna@example.com', role: 'User', avatar: 'https://i.pravatar.cc/150?img=4' },
    { id: 5, name: 'Ерлан Абдуллаев', email: 'erlan@example.com', role: 'User', avatar: 'https://i.pravatar.cc/150?img=5' },
    { id: 6, name: 'Амина Тулегенова', email: 'amina@example.com', role: 'User', avatar: 'https://i.pravatar.cc/150?img=6' },
  ];
